...
//    $pdfBase->drawText($page, number_format(($casTotal + $chqTotal + $othersTotal), 2), $leftPos + 500, $topPos - 30, $leftPos + 500, right);
   ...
   //             group by r.rev_desc";
	$sql5="SELECT if(r.rev_desc<>'',r.rev_desc,r.prec_desc) as Description,r.pay_mode,
		sum(IF(r.pay_mode='CASH' and mpesaref='', r.total,'')) AS Cash,
    ...
    $page->drawText(number_format($cTotal, 2), $leftPos + 250, $topPos - 95);
	$page->drawText(number_format($mTotal, 2), $leftPos + 330, $topPos - 95);
