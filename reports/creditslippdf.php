...
$sql2="SELECT DISTINCT b.pid,CONCAT(b.name_first,' ',name_last,' ',name_2) AS PatientNames,
c.`name` as company,s.`Slip_no`,s.slip_date,s.served_by,m.memberID, b.date_birth
    ...
    WHERE b.pid='$pid' and s.Slip_no='$slipNo'";
//echo $sql;
...
//     $topPos-=15;
// }
$page->drawText(" Please accord medical services to", $leftPos + 10, $topPos - 125);
$page->setStyle($headlineStyle4);
$page->drawText(strtoupper($row['PatientNames']), $leftPos + 10, $topPos - 140);
$page->setStyle($normalStyle4);
$page->drawText("Reg No: ".$pid." whose bill is payable by ", $leftPos + 10, $topPos - 155);
$page->setStyle($headlineStyle4);
$page->drawText($row['company'], $leftPos + 10, $topPos - 168);

$topPos=$topPos-30;
$page->drawText('MEMBER NO: '.$memberNo, $leftPos + 10, $topPos - 170);

$page->drawText('for ADMINISTRATOR', $leftPos + 10, $topPos - 185);
