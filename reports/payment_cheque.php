...
//        echo $r_sql;
        ...
        $page->setStyle($headlineStyle);
        $page->drawText(date('d-m-Y'), $leftPos + 550, $topPos - 20);
        $page->drawText(number_format($row[total], 2), $leftPos + 550, $topPos - 130);
        $page->drawText($row[payee], $leftPos + 80, $topPos - 200);
