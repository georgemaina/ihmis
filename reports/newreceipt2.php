...
<div class="book">
    ...
    echo "<div class='page'>";
     ...
     echo"<tr><td class='itemTitles'>Dates:</td><td class=invDetails colspan='3'>".date('Y-m-d H:i:s')."</td></tr>
          <tr><td class='itemTitles'>Receipt No:</td><td class=invDetails>".$_REQUEST['refno']."</td></tr>
          <tr><td class='itemTitles'>Patient No:</td><td class=invDetails>".$_REQUEST['patientid']."</td></tr>
         <tr><td class='itemTitles'>Customer:</td><td class=invDetails>".$_REQUEST['patientname']."</td></tr>
		 <tr><td class='itemTitles'>Towards:</td><td class=invDetails>Bill Payment</td></tr>
         <tr><td class='itemTitles'>Payment mode:</td><td class=invDetails>".$_REQUEST['paymode']."</td></tr>";
