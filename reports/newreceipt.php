...
<div class="book">
    ...
    echo "<div class='page'>";
     ...
     echo"<tr><td class='itemTitles'>Dates:</td><td colspan=2  class=invDetails>".date('Y-m-d H:i:s')."</td></tr>
          <tr><td class='itemTitles'>Receipt No:</td><td colspan=2  class=invDetails>".$_REQUEST['refno']."</td></tr>
          <tr><td class='itemTitles'>Payment mode:</td><td colspan=2  class=invDetails>".$_REQUEST['paymode']."</td></tr>";
