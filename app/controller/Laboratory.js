/*
 * File: app/controller/Laboratory.js
 *
...
Ext.define('CarePortal.controller.Laboratory', {
    extend: 'Ext.app.Controller',
    alias: 'controller.laboratory',
    ...
    loadTests: function(gridpanel, record, item, index, e, options) {
    ...
    closeResultsForm: function(button) {
        button.up('window').hide();
    },

    editLaboratory: function(gridpanel, record, item, index, e, options) {
        var source=gridpanel.up('grid').down('#Source').getValue();
        if(source=='Dashboard' || source=='Inpatient'){
            var labTests=Ext.create("CarePortal.view.LabItems",{});
