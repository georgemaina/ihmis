/*
 * File: app/controller/ProductsCatalog.js
 *
...
Ext.define('CarePortal.controller.ProductsCatalog', {
    extend: 'Ext.app.Controller',
    alias: 'controller.productscatalog',
    ...
    searchProducts: function(button) {
    ...
    openNewPrices: function(button) {
        var priceTypes=Ext.create('CarePortal.view.PriceTypes', {});
    ...
    filterProducts: function(field,newValue,oldValue,eOpts) {
