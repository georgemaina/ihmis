/*
 * File: app/view/DebtorsManager.js
 *
...
Ext.define('CarePortal.view.DebtorsManager', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.debtorsmanager',

    requires: [
        'CarePortal.view.undefinedViewModel9',
        'CarePortal.view.undefinedViewController9',
        'CarePortal.view.CustomerInfo',
        'Ext.form.Panel',
        'Ext.tab.Panel',
        'Ext.tab.Tab',
        'Ext.menu.Menu',
