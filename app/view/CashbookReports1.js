/*
 * File: app/view/CashbookReports1.js
 *
...
Ext.define('CarePortal.view.CashbookReports1', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.cashbookreports1',

    requires: [
        'CarePortal.view.CashbookReportsViewModel1',
        'Ext.button.Segmented',
        'Ext.button.Button'
    ],

    viewModel: {
        type: 'cashbookreports1'
    },
