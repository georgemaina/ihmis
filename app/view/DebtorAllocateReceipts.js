/*
 * File: app/view/DebtorAllocateReceipts.js
 *
...
Ext.define('CarePortal.view.DebtorAllocateReceipts', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.debtorallocatereceipts',

    requires: [
        'CarePortal.view.undefinedViewModel12',
        'Ext.grid.Panel',
        'Ext.view.Table',
