...
Ext.define('CarePortal.view.IssueDrugs', {
    extend: 'Ext.form.Panel',
    alias: 'widget.issuedrugs',

    requires: [
        'CarePortal.view.IssueDrugsViewModel',
        'CarePortal.view.IssueDrugsViewController',
    ...
    items: [
        ...
        },
        {
            ...
            x: 560,
            y: 580,
            itemId: 'cmdAddPrescription',
            iconCls: 'x-fa fa-print',
            text: 'Add / Edit Prescription'
        },
        {
