...
Ext.define('CarePortal.view.CashSalesAdj', {
    extend: 'Ext.form.Panel',
    alias: 'widget.cashsalesadj',

    requires: [
        'CarePortal.view.CashSalesViewModel6',
        'CarePortal.view.SalesGrid',
        'Ext.grid.Panel',
        'Ext.form.FieldSet',
        'Ext.form.RadioGroup',
    ...
    url: 'data/getDataFunctions.php?task=saveCashSalesAdj',
