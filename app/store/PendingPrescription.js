/*
 * File: app/store/PendingPrescription.js
 *
...
Ext.define('CarePortal.store.PendingPrescription', {
    extend: 'Ext.data.Store',
    alias: 'store.pendingprescription',

    requires: [
        'CarePortal.model.PendingPrescription',
        'Ext.data.proxy.Ajax',
